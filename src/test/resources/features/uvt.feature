Feature: UVT Calculation
	...
	Scenario: One fragment
		When the user views a fragment from 1 to 100000 milliseconds
		Then the UVT should be 100000 milliseconds
		
	Scenario: Two fragments, second inside the first
		When the user views a fragment from 1 to 100000 milliseconds
		And the user views a fragment from 1 to 50000 milliseconds
		Then the UVT should be 100000 milliseconds
		
	Scenario: Two separate fragments
		When the user views a fragment from 1 to 100000 milliseconds
		And the user views a fragment from 200001 to 300000 milliseconds
		Then the UVT should be 200000 milliseconds
		
	Scenario: Two overlapping fragments
		When the user views a fragment from 1 to 100000 milliseconds
		And the user views a fragment from 50001 to 300000 milliseconds
